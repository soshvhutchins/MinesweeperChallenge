...
public record RevealCellCommand : ICommand<GameDto>
{
...
public class RevealCellCommandValidator : AbstractValidator<RevealCellCommand>
{
    public RevealCellCommandValidator()
    {
        RuleFor(x => x.GameId)
            .NotEmpty()
